      ...
      <section className="py-16 px-5 bg-[#F8FAFC] border-t border-[#E2E8F0]">
        <div className="max-w-content mx-auto">
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4">
            {[
              { name: "أحمد م.", city: "الرياض", text: "المظلة فرقت كثير — المقود ما يحرق اليد وقت الظهر. ينباع.", stars: 5 },
              { name: "نورة ع.", city: "الدمام", text: "الحشوة رتبت السيارة تماماً، الجوال والمفاتيح صار لها مكان ثابت.", stars: 5 },
              { name: "خالد ر.", city: "جدة", text: "المكنسة اللاسلكية بعد مشوار البر — ذهب وجاء في دقيقتين. قوية وعملية.", stars: 5 },
