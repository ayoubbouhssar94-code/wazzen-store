      ...
      <section className="py-16 px-5 bg-[#F8FAFC] border-t border-[#E2E8F0]">
        <div className="max-w-content mx-auto">
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4">
            {[
              { name: "أحمد م.", city: "الرياض", text: "مظلة النانو سريعة في الفتح والطي وتغطي الزجاج بدون فوضى الألواح الكبيرة.", stars: 5 },
              { name: "نورة ع.", city: "الدمام", text: "AirSafe قاس الضغط ووقف تلقائياً عند الرقم المحدد. خليته في شنطة السيارة.", stars: 5 },
              { name: "خالد ر.", city: "جدة", text: "استخدمت GlassGuard على نقرة صغيرة مناسبة وخف وضوحها بعد اتباع الخطوات.", stars: 5 },
