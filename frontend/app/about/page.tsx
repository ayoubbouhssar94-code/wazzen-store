        ...
        <div className="max-w-content mx-auto">
          <div className="grid md:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <p className="text-[#64748B] leading-relaxed mb-4">
                وازن اختارت منتجاتها بناءً على المشاكل الفعلية التي يواجهها السائقون في المملكة: شمس تضرب الزجاج والطبلون، ضغط إطار ينخفض قبل المشوار، ونقرة صغيرة قد تتمدد في الزجاج الأمامي.
              </p>
        ...
        <div className="max-w-content mx-auto max-w-2xl text-center">
          ...
          <div className="grid md:grid-cols-3 gap-4 text-right">
            {[
              ...
              {
                icon: "🌪️",
                title: "طرق وحرارة قاسية",
                desc: "الحرارة والمسافات الطويلة تجعل متابعة ضغط الإطارات والاستعداد للطوارئ أكثر أهمية.",
              },
              {
                icon: "🚗",
                title: "مشاوير يومية طويلة",
                desc: "حصاة صغيرة أو ضغط منخفض قد يعطل المشوار؛ الحلول العملية تمنحك استعداداً أفضل.",
              },
            ].map((item, i) => (
