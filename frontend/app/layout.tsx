...
export const metadata: Metadata = {
  ...
  description:
    "وازن - حلول عملية للسائق في السعودية: عدة إصلاح شقوق الزجاج، مظلة زجاج أمامي قابلة للطي، ومنفاخ إطارات محمول ذكي. الدفع عند الاستلام.",
  ...
  openGraph: {
    ...
    description: "عدة إصلاح الشقوق، مظلة قابلة للطي، ومنفاخ إطارات محمول للسائق السعودي. الدفع عند الاستلام.",
    locale: "ar_SA",
    type: "website",
